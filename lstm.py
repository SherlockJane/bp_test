...
class LstmLayer(object):
    def __init__(self, input_width, state_width, learning_rate):
        ...
        self.Wfh, self.Wfx, self.bf = (self.init_weight_mat())  # 遗忘门权重矩阵
        self.Wih, self.Wix, self.bi = (self.init_weight_mat())  # 输入门
        self.Woh, self.Wox, self.bo = (self.init_weight_mat())  # 输出门
        self.Wch, self.Wcx, self.bc = (self.init_weight_mat())  # 单元状态
    ...
    def forward(self, x):
        ...
        self.ct_list.append(ct)  # 即时状态
        c = fg * self.c_list[self.times - 1] + ig * ct
        self.c_list.append(c)  # 单元状态
